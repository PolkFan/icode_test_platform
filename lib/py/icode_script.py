...
if __name__ == '__main__':
    ...
    phone = None
    brand_id = None
    # icodeScript().sqlupdate(choose,learner_id,start_time,schedule_id,section_id,phone,brand_id)

    # learner_id_list = [12099841,12099937,12099938,12099919,12099939,11607933]
